...
{50*"-"}
    Tool Version :     1.1
    Owner  :     DiLO.KiNG
    Facebook :  https:  ꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕ ꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕ ꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕꕕ
{50*"-"}'''
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get(https://github.com/DilOCyber/new-/blob/main/Approval.txt').text
